print("=======================================")
print(" Welcome to   Calorie Tracker For Daily Use! ")
print("=======================================")
print("You can record what you eat and check if you are within your daily calorie goal or not.\n")

meal_names = []
meal_calories = []

num_meals = int(input("How many meals did take you have today? "))
...
print("\n--------------------------------------")
print("            SUMMARY OF MEAL  ")
print("--------------------------------------")
print("Name of Meal\tCalories")
print("--------------------------------------")
